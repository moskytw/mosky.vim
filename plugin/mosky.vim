...
\ noremap <Leader>i2 i#!/usr/bin/env python<CR># -*- coding: utf-8 -*-<CR><CR><CR>from __future__ import division<CR>from __future__ import unicode_literals<CR>from __future__ import print_function<CR><CR><CR>|
